module CloakId
  ...
  class CloakIdEncoder
    ...
    def self.cloak_base36(id,key=0)
      self.cloak(id,key).to_s(36).upcase
    end
    ...
    def self.decloak_base36(cloaked_id, key=0)
    ...
    def self.cloak_mod_35(id, key=0, min_len=8)
      intermediate_id = self.cloak(id,key).to_s(35).upcase
    ...
    def self.decloak_mod_35(id,key=0)
